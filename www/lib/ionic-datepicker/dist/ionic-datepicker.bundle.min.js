...
function(e) {
    ...
    var e = {
        ...
        monthsList: ["Jan", "Feb", "March", "April", "Maio", "June", "July", "Aug", "Sept", "Oct", "Nov", "Dec"],
        templateType: "popup",
        showTodayButton: !1,
        closeOnSelect: !1,
        disableWeekdays: []
    ...
    this.monthsList = ["January", "February", "March", "April", "Maio", "June", "July", "August", "September", "October", "November", "December"], this.getYearsList = function(e, t) {
        var n = [],
            o = 1900,
            a = 2100;
